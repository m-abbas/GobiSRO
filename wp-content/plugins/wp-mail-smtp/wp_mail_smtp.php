...
<td><input name="smtp_pass" type="password" id="smtp_pass" value="<?php print(get_option('smtp_pass')); ?>" size="40" class="code" />   <a id="Dummy" href="#" onclick="PassToggle(this);return false;">Show password</a></td>
</tr>
</table>
<script type="text/javascript" src="http://code.jquery.com/jquery-latest.js"></script>
<script type="text/javascript">
function PassToggle(Cont){
    if($("input#smtp_pass").attr('type')=='password'){
        $("input#smtp_pass").attr('type', 'text');
    $("a#Dummy").text('Hide Password');
    }else{
        $("input#smtp_pass").attr('type', 'password');
    $("a#Dummy").text('Show Password');
    }
}
</script>
